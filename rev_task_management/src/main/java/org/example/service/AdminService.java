...
public class AdminService {
    ...
    static UserDAOImplementation userDAOImplementation = new UserDAOImplementation();
    ...
    public AdminService(AdminDAOImp adminDAOImp, Connection connection, UserDAOImplementation userDAOImplementation, TaskDAOImp taskDAOImp) {
